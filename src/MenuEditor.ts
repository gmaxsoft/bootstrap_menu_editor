...
export default class MenuEditor {
  ...
  public add(data: ItemDataset) {
    ...
    newItem.setListenerLinkButton(this.listenerLinkButton);
    newItem.buttonGroup.onClickLink(this.listenerLinkButton);
  ...
  public onClickLink(listener: Itemlistener) {
